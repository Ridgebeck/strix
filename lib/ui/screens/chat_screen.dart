...
class ChatScreen extends StatelessWidget {
  ...
  ChatScreen({Key? key, required this.roomData, required this.newMessage})
      : super(key: key);
      ...
      children: [
        ...
        Column(
          children: [
            Container(
              height: MediaQuery.of(context).size.height * 0.08 +
                  1.5 * MediaQuery.of(context).padding.top,
            ),
            Expanded(
              child: Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          List<Message> reversedList =
                              chatData.messages.reversed.toList();
